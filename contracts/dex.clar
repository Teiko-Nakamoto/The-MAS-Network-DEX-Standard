  ...
  (begin
    ...
    (let (
      ...
      (try! (contract-call? 'ST1F7QA2MDF17S807EPA36TSS8AMEFY4KA9TVGWXT.sbtc-token 
        transfer sbtc-swap-fee tx-sender 'STSRT3FWW891ZMM6FTPCDTXN006Q1549AVRB7V9Y (some 0x00)))
      ...
      (try! (as-contract (contract-call? 'ST37918Q7NBZ52AMV133VTY5C864KVK0S2HZ3CGA4.mas-sats 
...
(define-public (sell (tokens-in uint))
  (begin
    ...
    (let (
      ...
      (try! (contract-call? 'ST37918Q7NBZ52AMV133VTY5C864KVK0S2HZ3CGA4.mas-sats 
      ...
      ;; Transfer 0.6% immediately to swap fee wallet
      (try! (as-contract (contract-call? 'ST1F7QA2MDF17S807EPA36TSS8AMEFY4KA9TVGWXT.sbtc-token 
        transfer sbtc-swap-fee DEX_ADDRESS 'STSRT3FWW891ZMM6FTPCDTXN006Q1549AVRB7V9Y (some 0x00))))
...
(define-public (lock-tokens (amount uint))
  (begin
    ...
    (try! (contract-call? 'ST37918Q7NBZ52AMV133VTY5C864KVK0S2HZ3CGA4.mas-sats transfer amount tx-sender DEX_ADDRESS (some 0x00)))
...
(define-public (unlock-tokens (amount uint))
  (let (
    ...
    (begin
      ...
      (try! (as-contract (contract-call? 'ST37918Q7NBZ52AMV133VTY5C864KVK0S2HZ3CGA4.mas-sats transfer amount DEX_ADDRESS recipient (some 0x00))))
